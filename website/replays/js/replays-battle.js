...
_this.battle.messageShownTime=delayTable[_this.speed];
_this.battle.messageFadeTime=fadeTable[_this.speed];
...
renderControls=function renderControls(){var _this$battle18,_this$battle19,_this$battle20,_this$battle21,_this$result2,_this$result3;
var atEnd=(_this$battle18=this.battle)==null?void 0:_this$battle18.atQueueEnd;
var atStart=!((_this$battle19=this.battle)!=null&&_this$battle19.started);
...
preact.h("p",null,
atEnd?
preact.h("button",{onClick:this.replay,"class":"button",style:{width:'5em'}},
preact.h("i",{"class":"fa fa-undo"}),preact.h("br",null),"Replay"
):
(_this$battle20=this.battle)!=null&&_this$battle20.paused?
preact.h("button",{onClick:this.play,"class":"button",style:{width:'5em'}},
preact.h("i",{"class":"fa fa-play"}),preact.h("br",null),"Play"
):

preact.h("button",{onClick:this.pause,"class":"button",style:{width:'5em'}},
preact.h("i",{"class":"fa fa-pause"}),preact.h("br",null),"Pause"
),
" ",
preact.h("button",{"class":"button button-first"+(atStart?" disabled":""),onClick:this.firstTurn},
preact.h("i",{"class":"fa fa-fast-backward"}),preact.h("br",null),"First turn"
),
preact.h("button",{"class":"button button-middle"+(atStart?" disabled":""),onClick:this.prevTurn},
preact.h("i",{"class":"fa fa-step-backward"}),preact.h("br",null),"Prev turn"
),
preact.h("button",{"class":"button button-middle"+(atEnd?" disabled":""),onClick:this.nextTurn},
preact.h("i",{"class":"fa fa-step-forward"}),preact.h("br",null),"Skip turn"
),
preact.h("button",{"class":"button button-last"+(atEnd?" disabled":""),onClick:this.lastTurn},
preact.h("i",{"class":"fa fa-fast-forward"}),preact.h("br",null),"Skip to end"
)," ",
preact.h("button",{"class":"button",onClick:this.openTurn},
preact.h("i",{"class":"fa fa-repeat"})," Skip to turn..."
)
),
preact.h("p",null,
preact.h("label",{"class":"optgroup"},"Speed:",
preact.h("br",null),
preact.h("select",{name:"speed","class":"button",onChange:this.changeSpeed,value:this.speed},
...
preact.h("br",null),
preact.h("select",{name:"speed","class":"button",onChange:this.changeSound,value:BattleSound.muted?'off':'on'},
...
preact.h("br",null),
preact.h("button",{onClick:this.switchViewpoint,"class":this.battle?'button':'button disabled'},
(_this$battle21=this.battle)!=null&&_this$battle21.viewpointSwitched?(_this$result2=this.result)==null?void 0:_this$result2.p2:(_this$result3=this.result)==null?void 0:_this$result3.p1," ",
preact.h("i",{"class":"fa fa-random","aria-label":"Switch viewpoint"})
)
)
),
this.result?preact.h("h1",null,
preact.h("strong",null,this.result.format),": ",this.result.p1," vs. ",this.result.p2
):preact.h("h1",null,
