...
preact.h("small",null,"[",_this5.formatid(result),"]",result.rating?" Rating: "+result.rating:'',preact.h("br",null)),
preact.h("strong",null,result.p1)," vs. ",preact.h("strong",null,result.p2)
)
);}))
);
return preact.h("div",{"class":PSRouter.showingRight()?'sidebar':''},preact.h("section",{"class":"section first-section"},
preact.h("h1",null,"Search replays"),
preact.h("form",{onSubmit:this.submitForm},
preact.h("p",null,
preact.h("label",null,"Username:",preact.h("br",null),
...
preact.h("a",{href:this.modLink({sort:'date',page:1}),"class":"button button-first"+(this.byRating?'':' disabled')},"Date"),
preact.h("a",{href:this.modLink({sort:'rating',page:1}),"class":"button button-last"+(this.byRating?' disabled':'')},"Rating")
),
...
),!activelySearching&&preact.h(FeaturedReplays,null),!activelySearching&&preact.h("section",{"class":"section"},
...
preact.h("li",null,preact.h("a",{href:"anythinggoes-218380995","class":"blocklink"},
...
PSReplays=function(_preact$Component3){_inheritsLoose(PSReplays,_preact$Component3);function PSReplays(){return _preact$Component3.apply(this,arguments)||this;}var _proto4=PSReplays.prototype;_proto4.
...
};return PSReplays;}(preact.Component);
